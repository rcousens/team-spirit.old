...
app-composer-install:
  cmd.run:
    ...
    - cwd: /srv/www/ts.dev
    - unless: test -f /srv/www/ts.dev/vendor
    - user: vagrant
    - group: vagrant
    - order: last
...
app-npm-install:
  cmd.run:
    ...
    - cwd: /srv/www/ts.dev
    - unless: test -f /srv/www/ts.dev/node_modules
    - user: vagrant
    - group: vagrant
    - order: last
...
set-cache-permissions:
  cmd.run:
    - name: 'SETFACL=`which setfacl`; $SETFACL -R -m u:apache:rwX /srv/www; $SETFACL -dR -m u:apache:rwX /srv/www'
    - order: last
